...
Menu desplegable
    ...
    Sleep    1s
    Click Element    xpath=//*[@id="collapse2"]/div/ul/li[23]/a
    Wait Until Element Is Not Visible    xpath=${load}    ${Tme_load}

C001 Generar reporte de Cambios habitaciones por hotel
    Sleep    1s
    ...
    Click Element    xpath=//*[@id="comboHotel"]/option[75]
    Click Element    xpath=//*[@id="contentFiltro"]/div/div/div[2]/div[2]/div/button[1]
    Wait Until Element Is Not Visible    xpath=${load}    ${Tme_load}
    Sleep    1s
    Element Should Be Visible    //*[@id="resultTableCambiosPax"]/thead
    Close Browser
