...
Menu desplegable
    ...
    Sleep    1s
    Click Element    xpath=//*[@id="collapse2"]/div/ul/li[14]/a
    Wait Until Element Is Not Visible    xpath=${load}    ${Tme_load}


C001 Generar información de locaciones experience
    Wait Until Element Is Not Visible    xpath=${load}    ${Tme_load}
    Sleep    1s
    ...
    Click Button    xpath=//*[@id="contentFiltroReporte"]/div/div/div[2]/div[6]/button[1]
    Wait Until Element Is Not Visible    xpath=${load}    ${Tme_load}

C002 Generar excel
    Wait Until Element Is Not Visible    xpath=${load}    ${Tme_load}
    Sleep    1s
    Click Button    xpath=//*[@id="contentFiltroReporte"]/div/div/div[2]/div[6]/button[2]
