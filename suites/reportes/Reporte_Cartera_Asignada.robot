...
Menu desplegable
    ...
    Sleep    1s
    Click Element    xpath=//*[@id="collapse2"]/div/ul/li[30]/a
    Wait Until Element Is Not Visible    xpath=${load}    ${Tme_load}


C001 Generar reporte de cartera asignada
    Sleep    1s
    ...
    Click Element    xpath=//*[@id="Pagos_Desde"]
    Click Element    xpath=//*[@id="contentFiltro"]/div/div/div[2]/div/div[4]/div/div/div[1]/table/thead/tr[1]/th[1]/i
    Click Element    xpath=//*[@id="contentFiltro"]/div/div/div[2]/div/div[4]/div/div/div[1]/table/tbody/tr[2]/td[1]
    Click Element    xpath=//*[@id="Pagos_Hasta"]
    Click Element    xpath=//*[@id="contentFiltro"]/div/div/div[2]/div/div[5]/div/div/div[1]/table/thead/tr[1]/th[1]/i
    Click Element    xpath=//*[@id="contentFiltro"]/div/div/div[2]/div/div[5]/div/div/div[1]/table/tbody/tr[5]/td[1]
