...
Menu desplegable
    ...
    Sleep    1s
    Click Element    xpath=//*[@id="collapse2"]/div/ul/li[21]/a
    Wait Until Element Is Not Visible    xpath=${load}    ${Tme_load}

C001 Generar reporte detalle de facturas
    Sleep    1s
    Click Element    xpath=//*[@id="fechaInicioA"]
    ...
    Click Element    xpath=//*[@id="fechaFinA"]
